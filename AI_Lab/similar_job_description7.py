...
Usage:
    python similar_job_description_tutorial7_sbert.py
"""
...
class JobMatchingSystem:
    ...
    def _convert_to_db_format(self, match_result: JobMatchResult) -> Dict[str, Any]:
        ...
        Returns:
            {
                "sim_position": "Software Development",
                "sim_industry": "Front-end Development",
                "sim_score": 0.6541,
                "sim_skill_matching": ["react", "git", "css"]
            }
        """
        return {
            "sim_position": match_result.job_name,
            "sim_industry": match_result.industry,
