...
from app.core.agents.chatbot.prompts.system_prompts import SQL_GENERATION_PROMPT_TEMPLATE, INSIGHT_GENERATION_PROMPT_TEMPLATE
...
class SQLAnalysisAgent(BaseAgent):
    ...
    async def execute(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            llm_raw_response = sql_result.get("_raw_response", None)  # LLM 원본 응답
            ...
            # 로그 저장
            self.query_logger.log_query_generation(
                question=question,
