...
6. ⭐ meta_data에는 오직 추가적인 보조 정보만 포함 (예: 자격요건, 우대사항, 복리후생, 담당업무, 학력요건, 전형절차 등)
7. ⭐ meta_data에는 기술스택/소프트스킬을 넣지 않는다 (예: Python, Django, AWS, Docker 등 제외)
8. ⭐ meta_data 키는 절대 영어를 사용하지 말고 반드시 한국어만 사용할 것
